    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <figure>
            <?php echo "<img src='".$oneMovie['movie_image']."' alt='Image' class='img-fluid single'>" ; ?>
            </div>
            <div class="col-lg-6 my-auto">
            <!-- <figcaption>This is an image</figcaption> -->
            <?php echo "<h2 class='text-white'>".$oneMovie['movie_title']."</h2>"; ?>
          </figure>

          <?php echo "<p>".$oneMovie['movie_body']."</p>"; ?>
          ...
          <div class="pt-3">
            <?php echo "<p>Categories: <a href='#'>".$movie->getCategoryTitle($oneMovie['movie_category_id'])['category_title']."</a></p>";?>
            <?php echo "<p>Length: <span class='text-primary'>".$oneMovie['movie_length']." min</span></p>" ;?>
            <?php echo "<p>Place: <span class='text-primary'>".$oneMovie['movie_screen']."</span></p>"; ?>
          </div>

          <?php echo "<a href='schedule.php?id=".$oneMovie['movie_id']."' class='btn btn-primary text-white p-2 my-3'>Look Schedule</a>";?>  
          </div>
         </div>
      </div>
    </div>
