...
<body>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade-up" data-aos-delay="400">
          ...
          <h1 class="text-white">Confirm Info</h1>
  ...
  <div class="site-section">
    <div class="container">
        <h1 class="my-4 text-white">Confirm Your Info</h1>
        <form action="#" class="contact-form">
            ...
            <div class="row form-group">
                <div class="col-md-12">
                <?php echo "<a href='confirmTicket.php?id=".$id."&date=".$date."&time=".$time."&child=".$ticket_child."&adult=".$ticket_adult."
                &student=".$ticket_student."&total=".$ticket_total."&name=".$name."&email=".$email."' role='button' class='btn btn-primary  py-2 w-25 mt-4'>Confirm</a>";?>
                </div>
            </div>
