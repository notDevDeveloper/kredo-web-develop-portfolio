...
<html lang="en">
  ...
  <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
    ...
    <div class="container">
        <div class="row">
         <div class="introright m-5">
              <div class="introright-header">
                <h3><span class="line">Twitter</span></h3>
                <a class="twitter-timeline" href="https://twitter.com/KGtakuya1120" data-height="300" data-chrome="nofooter" data-link-color="#820bbb">Tweets by GENSAY169</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
        

              </div>
        </div>

        <iframe class="note-embed" src="https://note.mu/embed/notes/n6078d24f5957" style="border: 0; display: block; max-width: 99%; width: 494px; padding: 0px; margin: 10px 0px; position: static; visibility: visible;" height="400"></iframe><script async src="https://note.mu/scripts/embed.js" charset="utf-8"></script>
