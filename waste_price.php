    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0 mr-2"><a href="login.php" class="btn btn-secondary py-2 px-3">Login</a></p>
	      <p class="button-custom order-lg-last mb-0"><a href="application.php" class="btn btn-danger py-2 px-3">Apply An Application</a></p>	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item"><a href="index.php" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item"><a href="about.php" class="nav-link">About</a></li>
	        	<li class="nav-item"><a href="doctor.php" class="nav-link">Teacher</a></li>
	        	<li class="nav-item"><a href="department.php" class="nav-link">Course</a></li>
        	...
        	<div class="col-md-8 heading-section text-center ftco-animate">
        		<div class="pricing-entry pb-5 text-center">
        			<div>
	        			...
	        			<p><span class="price" style ="color: #fc602f;">$30.00</span> <span class="per">/ session</span></p>
	        		</div>
        			<ul>
