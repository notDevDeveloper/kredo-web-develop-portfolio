    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/Tutor_home_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
		...
		<section class="ftco-section">
			<div class="container">
				<div class="row">
				<?php  foreach($teachers as $key=>$values) {?>
					<div class="col-md-6 col-lg-4 ftco-animate">
					<a href ="teacher_single.php?id=<?php echo $values['teacher_id']; ?>" ><div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(<?php echo $values['teacher_image']; ?>);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3><?php echo $values['teacher_name']; ?></h3>
								<span class="position mb-2">Qualified Teacher</span>
								<div class="faded">
									<h3>CEFR:<span class="red"><?php echo $values['teacher_cefr']; ?></span></h3>
									<h3>Specialty: <span class="red"><?php echo $values['teacher_specialty']; ?></span></h3>
