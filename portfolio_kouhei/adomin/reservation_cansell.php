    ...
    <br>
     ...
     <div class="container">
        ...
        <form action="" method="post" >
            <h4 class="">Are you sure you're going to cansell this reservation?</h4>
            ...
            <div class="row">
              <div class="text-center col-md-3 d-inline-block">
                <div class="form-group">
                  <input type="submit" value="Submit" name="submit" class="btn btn-danger text-white">
                  <a class="btn btn-outline-dark" href="reservation_table.php" role="button">Close</a>
                </div>
              </div>    
            </div>  
        </form>
