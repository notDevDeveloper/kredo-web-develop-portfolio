...
if(isset($_POST['registration'])){
    ...
    $result = $customer->addCustomer($customer_name,$customer_phone,$customer_mail,$customer_password,$customer_address,$customer_gender,$customer_age);
    
    if($result){
        echo "Succesfully Added";
        header('Location: signup_confirmation.php?id='.$result);   //”?id='.$result”を使うことでsignup_confirmationのに表示される
    }else{
        echo "Unseccessful!";
    }
}
        ...
        <div class="row">
          <div class="col-md-7 mx-auto d-block" data-aos="fade-up" data-aos-delay="100">
            <form action="#" method="post" class="bg-white p-md-5 p-4 mb-5 border">
                <h3 class="text-center">Please Your Information</h3><br>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" name="address" id="text" class="form-control ">
                </div>
              </div>
              ...
              <div class=" col-md-6 mx-auto d-block">
                <!-- <a href="" type="submit" name="registration" value="Reserve Now" class="btn btn-primary text-white py-3 px-5 font-weight-bold mx-auto d-block">Registration</a> -->
                <input type="submit" value="Registration" name="registration" id="" class="btn btn-outline-warning">
              </div>
            </form>
           </div>
          </div>
