...
if(isset($_POST['submit'])){
  ...
  $result = $stock->addContact($contact_name, $contact_email, $contact_subject, $contact_message);
  ...
  <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			<div class="container">
              ...
              <div class="form-group">
                <input type="submit" name ="submit" value="Send Message" class="btn btn-danger py-3 px-5" >
              </div>
            </form>
					</div>
