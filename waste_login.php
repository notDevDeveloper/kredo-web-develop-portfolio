...
<html lang="en">
  ...
  <body>
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0 mr-2"><a href="login.html" class="btn btn-secondary py-2 px-3">Login</a></p>
	      <p class="button-custom order-lg-last mb-0"><a href="application.html" class="btn btn-danger py-2 px-3">Apply An Application</a></p>	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item"><a href="index.html" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item"><a href="about.html" class="nav-link">About</a></li>
	        	<li class="nav-item"><a href="doctor.html" class="nav-link">Teacher</a></li>
	        	<li class="nav-item"><a href="department.html" class="nav-link">Course</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/Tutor_home_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Your Page</h1>
    	...
    	<div class="container">
    		<div class="row">
          <div class="col-md-12 py-5 pr-md-5 text-center" style = "background-color: #fc602f;">
              <div class="heading-section heading-section-white ftco-animate mb-5">
                <span class="subheading">Request</span>
                <h2 class="mb-4">Request Form</h2>
                <p>Please write down your convenient time. We will try to adjust your request as much as possible.</p>
              </div>
                ...
                <div class="d-md-flex">
                  <div class="form-group">
                    <div class="input-wrap">
                      ...
                      <input type="text" class="form-control appointment_date" placeholder="Your desired Date for Consultation">
                    </div>
                  </div>
                  <div class="form-group ml-md-4">
                    <div class="input-wrap">
                      <div class="icon"><span class="ion-ios-clock"></span></div>
                      <input type="text" class="form-control appointment_time" placeholder="Your desired Stary Time for Comsultation">
                    </div>
                  </div>
                </div>
                <div class="d-md-flex">
      ...
      <div class="col-md-12 py-5 pr-md-5 text-center" style ="background-color: #fff">
          <div class="heading-section heading-section-white ftco-animate mb-5">
              <span class="subheading" style ="color: black;">Application</span>
            <h2 class="mb-4"><a href="application.html">➡︎Application Form</a></h2>
            <p style ="color: black;">If you want to apply an application now.Please press here.</p>
          </div> -->
          <!-- <form action="#" class="appointment-form ftco-animate">
                    <div class="d-md-flex">
                        <div class="form-group">
