<?php 
    ...
    $contacts = $admin->displayContact();
    $users = $admin->displayUser();
    $teachers = $admin->displayTeacher();
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="addteacher.php" class="waves-effect"><i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>AddTeacher</a>
                    </li>
                    <li>
                        <a href="addcourse.php" class="waves-effect"><i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>AddCourse</a>
                    </li>
                    <li>
                        <a href="signup_admin.php" class="waves-effect"><i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>SignupAdmin</a>
                    </li>
                </ul>
                                    ...
                                    <tbody>
                                        <?php 
                                            foreach($contacts as $key=>$values){
                                                ...
                                                echo "<td>".$values['contact_id']."</td>";

												echo "<td>".$values['contact_name']."</td>";
												echo "<td>".$values['contact_email']."</td>";
												echo "<td>".$values['contact_subject']."</td>";
												echo "<td>".$values['contact_message']."</td>";
