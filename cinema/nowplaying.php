...
<head>
  <title>nowplaying &mdash; Colorlib Website Template</title>
  <meta charset="utf-8">
      ...
      <?php
        ...
        foreach($movies as $key => $values){
          ...
          echo "<div class='col-md-6 col-lg-4 mb-5' data-aos='fade-up' data-aos-delay='100'>";
              echo "<a href='single.php?id=".$values['movie_id']."'><img src='".$values['movie_image']."' alt='Image' class='img-fluid img'></a>";
              echo "<div class='p-4 bg-white'>";
                echo "<span class='d-block text-secondary small text-uppercase'>".$movie->getCategoryTitle($values['movie_category_id'])['category_title']."</span>";
                echo "<h2 class='h5 text-black mb-3'><a href='single.php?id=".$values['movie_id']."'>".$values['movie_title']."</a></h2>";
               echo "</div>";
            echo "</div>";
        }
        echo "</div>";
