<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $ticket_total = $_POST['total'];
        $name = $_POST['name'];
        $email = $_POST['email'];
        // $pass = $_POST['pass'];
        header('Location: confirm.php?id='.$id.'&date='.$date.'&time='.$time.'&child='.$ticket_child.'&adult='.$ticket_adult.
                '&student='.$ticket_student."&total=".$ticket_total.'&name='.$name.'&email='.$email);
    }
...
<body>
  ...
  <div class="site-section">
    <div class="container">
        <h1 class="my-4 text-white">Enter Your Info</h1>
        <form action="" method="post" class="contact-form">
  
            <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                <label class="font-weight-bold" for="fullname">Full Name</label>
                <input type="text" value="<?php echo "$name0" ;?>"  name="name" class="form-control" placeholder="Full Name">
                </div>
            </div>
            <div class="row form-group">
                <div class="col-md-12">
                <label class="font-weight-bold" for="email">Email</label>
                <input type="email" value="<?php echo "$email0" ;?>"  name="email" class="form-control" placeholder="Email Address">
                </div>
            </div>
            <!-- <div class="row form-group">
                <div class="col-md-12">
                ...
                <input type="submit" value="Submit" name="submit" class="btn btn-primary py-2 px-3 mt-4">
