        ...
        <h1  class="text-primary ranking">TOP 1</h1>
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <figure>
                    <?php echo "<img src='".$oneMovie1['movie_image']."' alt='Image' class='img-fluid single'>" ; ?>
                </div>
                <div class="col-lg-6 my-auto">
                    <!-- <figcaption>This is an image</figcaption> -->
                    <?php echo "<h2 class='text-white'>".$oneMovie1['movie_title']."</h2>"; ?>
                    </figure>

                    <?php echo "<p>".$oneMovie1['movie_body']."</p>"; ?>
                    ...
                    <div class="pt-3">
                        <?php echo "<p>Categories: <a href='#'>".$movie->getCategoryTitle($oneMovie1['movie_category_id'])['category_title']."</a></p>";?>
                        <?php echo "<p>Length: <span class='text-primary'>".$oneMovie1['movie_length']." min</span></p>" ;?>
                        <?php echo "<p>Place: <span class='text-primary'>".$oneMovie1['movie_screen']."</span></p>"; ?>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <figure>
                    <?php echo "<img src='".$oneMovie2['movie_image']."' alt='Image' class='img-fluid single'>" ; ?>
                </div>
                <div class="col-lg-6 my-auto">
                    <!-- <figcaption>This is an image</figcaption> -->
                    <?php echo "<h2 class='text-white'>".$oneMovie2['movie_title']."</h2>"; ?>
                    </figure>

                    <?php echo "<p>".$oneMovie2['movie_body']."</p>"; ?>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ratione dolores expedita id repudiandae
                        nostrum aut, impedit repellat nam veritatis, pariatur facere reprehenderit alias atque molestias ipsum officia
                        asperiores possimus eos, quis nemo hic. Autem molestias dolorum blanditiis quibusdam culpa nobis quam, soluta
                        quasi quis, fugiat delectus pariatur, eos quae.</p>
                    ...
                    <div class="pt-3">
                        <?php echo "<p>Categories: <a href='#'>".$movie->getCategoryTitle($oneMovie2['movie_category_id'])['category_title']."</a></p>";?>
                        <?php echo "<p>Length: <span class='text-primary'>".$oneMovie2['movie_length']." min</span></p>" ;?>
                        <?php echo "<p>Place: <span class='text-primary'>".$oneMovie2['movie_screen']."</span></p>"; ?>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <figure>
                    <?php echo "<img src='".$oneMovie3['movie_image']."' alt='Image' class='img-fluid single'>" ; ?>
                </div>
                <div class="col-lg-6 my-auto">
                    <!-- <figcaption>This is an image</figcaption> -->
                    <?php echo "<h2 class='text-white'>".$oneMovie3['movie_title']."</h2>"; ?>
                    </figure>

                    <?php echo "<p>".$oneMovie3['movie_body']."</p>"; ?>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil ratione dolores expedita id repudiandae
                        nostrum aut, impedit repellat nam veritatis, pariatur facere reprehenderit alias atque molestias ipsum officia
                        asperiores possimus eos, quis nemo hic. Autem molestias dolorum blanditiis quibusdam culpa nobis quam, soluta
                        quasi quis, fugiat delectus pariatur, eos quae.</p>
                    ...
                    <div class="pt-3">
                        <?php echo "<p>Categories: <a href='#'>".$movie->getCategoryTitle($oneMovie3['movie_category_id'])['category_title']."</a></p>";?>
                        <?php echo "<p>Length: <span class='text-primary'>".$oneMovie3['movie_length']." min</span></p>" ;?>
                        <?php echo "<p>Place: <span class='text-primary'>".$oneMovie3['movie_screen']."</span></p>"; ?>
                    </div>

                    <?php echo "<a href='schedule.php?id=".$oneMovie3['movie_id']."' class='btn btn-primary text-white p-2 my-3'>Look Schedule</a>";?>  
                </div>
            </div>
