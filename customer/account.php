<?php
    ...
    // reservation my account

    $reservation = new Reservation;
    $reservations = $reservation->displayReservations($id);
            ...
            <form action="#" method="post" class="bg-white p-md-5 p-4 mb-5 border">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control" value="<?php echo $customers['customer_name'];?>">
                </div>
                <div class="col-md-6 form-group">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" name="address" id="text" class="form-control" value="<?php echo $customers['customer_address'];?>" required>
                </div>
              </div>
              ...
              <div class="text-center">
                ...
                <div class="col-md-3 d-inline-block">
                  ...
                  <input type="submit" name="edit" value="Edit" class="btn btn-primary text-white py-3 px-5 font-weight-bold">
                </div>
                <div class="col-md-3 d-inline-block">  
                  <a href="account_delete.php" type="delete" value="delete" name="delete" class="btn btn-secondary text-white py-3 px-5 font-weight-bold">Delete</a>
                  <!-- <input type="submit" href="account_delete.php"  name="delete" value="Delete" class="btn btn-secondary text-white py-3 px-5 font-weight-bold"> -->
                </div>
              </div>
            </form>
