<?php
    ...
    if(isset($_POST['edit'])){
      // $reservation_check_in = $_POST['checkin'];
      // $reservation_check_out = $_POST['checkout'];
...
<html>
  <head>
    ...
    <title>Hotel reservation edit</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mx-auto d-block" data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="">Name: <?php echo $reservations['customer_name'];?></p>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      <select name="room" id="roomid" class="form-control" value="<?php echo $reservations['reservatio_room_id'];?>">
