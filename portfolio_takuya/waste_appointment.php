...
if(isset($_POST['submit'])){
  $appointment_student_name = $_SESSION['name'];
  $appointment_student_email = $_SESSION['email'];
  $appointment_date= $_POST['date'];
  $appointment_teacher= $_POST['teacher'];
  $appointment_timezone = $_POST['timezone'];
  $appointment_message = $_POST['message'];
  
  $result = $stock->addAppointment($appointment_student_name, $appointment_student_email, $appointment_date, $appointment_teacher, $appointment_timezone, $appointment_message);
  ...
  <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item active"><a href="appointment.php" class="nav-link">Appointment</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/Tutor_home_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
                <div class="col-md-12 py-5 pr-md-5 text-center" style =" border:solid 3px red; background-color: #ed5014">
              ...
              <form action="#" class="appointment-form ftco-animate" method ="post">
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                                ...
                                foreach($listteachers as $key=> $values){
                                    echo "<option value='".$values['teacher_name']."'>".$values['teacher_name']."</option>";
                                }
                            ?>
                            </select>
                          </div>
                        ...
                        <div class="form-group">
                            <input type="date" name="date" class="form-control" value="<?php date('T-m-d'); ?>">
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              <textarea name="message" id="" cols="30" rows="2" class="form-control ml-3" placeholder="Message"></textarea>
                            </div>
                      </div>
                    <div class="form-group ml-md-4">
                      <input type="submit" name = "submit" value="Appointment" class="btn btn-secondary mx-auto">
                    </div>
                    </form>
                </div>
    			...
    			<!-- <div class="col-md-12 py-5 pr-md-5 mr-5 text-center" style = "background-color: #fff;">
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	          	<span class="subheading" style ="color : black;">Consultation</span>
	            <h2 class="mb-4"><a href ="appointment.html">➡︎Free Consultation</a></h2>
	            <p style ="color :black;" >If you have any concerns please consult　us once.</p>
	          </div>
